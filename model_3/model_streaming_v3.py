...
CHECKPOINT_SAVE_PATH = os.path.join(SCRIPT_DIR, "modelV3.0.pt")  # Chemin du modele a SAUVEGARDER (ecriture). Exemple: "C:/.../modele_streaming.pt"
...
if __name__ == "__main__":
    ...
    print("nouveau model 3")
    print("transformeurs")  # Ce bloc s'execute seulement si on lance ce fichier directement. Exemple: python modele_streaming.py
  ...
  # Message pour voir que le script a bien demarre. Exemple affiche: debut
    ...
    optimizer = torch.optim.SGD(  # Cree l'optimiseur SGD pour entrainer les 3 blocs du modele. Exemple: lr=0.05
        list(emb_layer.parameters()) + list(transformer.parameters()) + list(fc.parameters()),  # Liste tous les poids a mettre a jour
