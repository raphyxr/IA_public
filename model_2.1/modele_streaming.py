...
CHECKPOINT_LOAD_PATH = os.path.join(SCRIPT_DIR, "model_V2.1.pt")  # Chemin du modele a CHARGER (lecture). Exemple: "C:/.../modele_streaming.pt"
CHECKPOINT_SAVE_PATH = os.path.join(SCRIPT_DIR, "model_V2.1.pt")  # Chemin du modele a SAUVEGARDER (ecriture). Exemple: "C:/.../modele_streaming.pt"
...
if __name__ == "__main__":
    ...
    print("nouveau model 2.1.1")  # Ce bloc s'execute seulement si on lance ce fichier directement. Exemple: python modele_streaming.py
